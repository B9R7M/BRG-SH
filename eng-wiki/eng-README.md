...
[!WARNING]
Disabling sudo password reduces system security.
...
[!TIP]
The script uses mkdir -p in all directory creations. If it still fails, create the directories manually and try again.
...
Some ROMs use their own variants (e.g., gms_core, gms_pico, vanilla). Consult your ROM's documentation.
...
MIT — Do whatever you want, but without warranties. Use at your own risk.
